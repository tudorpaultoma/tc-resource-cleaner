...
When you create a CVM, CLB, CBS disk, EIP, ENI, HAVIP, Snapshot, NAT Gateway, or Auto Scaling group — a serverless function automatically tags it with: owner, creation date, TTL (default: 3 days), project, and deletion eligibility.
...
CLB, CBS, EIP, ENI, HAVIP, Snapshot, NAT Gateway, and Auto Scaling resources are **deleted when their TTL expires**, provided they are not assigned to a project and not actively in use; bound disks/EIPs/ENIs are always safe, but they have CVM's lifecycle.
...
**Covered services:** CVM, CDH, CLB, CBS, EIP, ENI, HAVIP, Snapshot, NAT Gateway, Auto Scaling — across 18 regions.
